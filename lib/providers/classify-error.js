...
export function classifyProviderError(err) {
  ...
  if (/\b(408|429|502|503|504)\b|rate.?limit|rate_limit|too.?many.?requests|resource.*exhausted|quota.*exceeded|high.?demand|overload|service.?unavailable|temporarily.?unavailable|request.?timeout/i.test(msg)) {
    return {
      retryable: true,
      category: 'rate-limit',
