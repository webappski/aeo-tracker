...
export function classifyProviderError(err) {
  ...
  if (/\b(429|503|502|504)\b|rate.?limit|rate_limit|too.?many.?requests|resource.*exhausted|quota.*exceeded|high.?demand|overload|service.?unavailable|temporarily.?unavailable/i.test(msg)) {
    return {
      retryable: true,
      category: 'rate-limit',
