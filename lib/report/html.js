...
export function renderHtml(summary, snapshots = null, opts = {}) {
  ...
  const SECTIONS = [
    ...
    { id: 'citations',   num: '04', label: 'Citations',   subtitle: 'who AI cites about your category',     cells: citationsCells,
      emptyMsg: 'No citations earned this run. Domains aren\'t in AI engines\' source pools yet — citation pickup is the unlock. Run aeo-tracker run weekly to track this.' },
    { id: 'actions',     num: '05', label: 'Actions',     subtitle: 'what to ship this week',               cells: actionsCells,
      emptyMsg: 'Action plan generates after the LLM-recommendations pass during aeo-tracker report. Re-run report --html to populate.' },
    { id: 'diagnostics', num: '06', label: 'Diagnostics', subtitle: 'site readiness, cost, ads',            cells: diagnosticsCells,
      emptyMsg: 'Diagnostic data populates during aeo-tracker report — re-run to fetch crawlability, authority, and cost cells.' },
  ];
...
<main class="page">
  ...
  <header class="mast">
    <div class="mast-tools">
      <div class="mast-mark"><span class="mast-mark-dot" aria-hidden="true"></span><strong>aeo-tracker</strong>${opts.pkgVersion ? `<span class="mast-mark-ver">v${esc(opts.pkgVersion)}</span>` : ''}</div>
      <dl class="mast-meta">
  ...
  <footer class="colophon">
    ...
    <div class="colophon-meta">
      <span><strong>@webappski/aeo-tracker</strong></span>
