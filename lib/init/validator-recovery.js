...
export function formatRecoveryPanel({
  ...
  const lines = [];
  lines.push('');
  // 1.0.6: honest "X of 5 commercial candidates" header when threaded from
  // cmdInit. Legacy fallback otherwise (e.g. --keywords mode, where no
  // brainstorm + substitution happened).
