...
- **AI-Bot Crawl Readiness** — 0-100 composite over crawlability inputs (robots 30% · bots-not-blocked 25% · sitemap 25% · llms.txt 20%). Measures TECHNICAL access for AI crawlers, not actual answer-pool inclusion — that's driven by off-page authority (Wikipedia / Reddit / review platforms), surfaced separately.
